...
{
    [TLObject(354925740)]
    public class TLSecureSecretSettings : TLAbsSecureSecretSettings
    {
        ...
        public override void DeserializeBody(BinaryReader br)
        {
			...
			SecureSecret = (byte[])ObjectUtils.DeserializeObject(br);
        ...
        public override void SerializeBody(BinaryWriter bw)
        {
			...
			ObjectUtils.SerializeObject(SecureSecret, bw);
